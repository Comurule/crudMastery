...
exports.postPostCreate = async ( req, res, next) => {
    ...
    try{
        ...
        const actionType = 'create';
            ...
            const addCategories = await CreateOrUpdateCategories (req, res, post, actionType);
...
exports.postPostUpdate = async (req, res, next) => {
    try {
        ...
        const data = await models.Post.update(
            ...
            //Success Response
            success_res_with_data( res, 'Post updated successfully', data );
            console.log("Post updated successfully");
...
const CreateOrUpdateCategories = async (req, res, post, actionType) => {
    try {
